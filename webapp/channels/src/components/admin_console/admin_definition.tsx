...
const AdminDefinition: AdminDefinitionType = {
                ...
                schema: {
                    ...
                    settings: [
                        ...
                        },
                        {
                            ...
                            label: defineMessage({id: 'admin.customization.defaultTheme.title', defaultMessage: 'Default Theme:'}),
                            help_text: defineMessage({id: 'admin.customization.defaultTheme.desc', defaultMessage: 'Set the default theme applied to all new users. When "Require Theme" is enabled, this theme is enforced for all users.'}),
                            options: [
                                {value: 'denim', display_name: defineMessage({id: 'admin.customization.defaultTheme.options.denim', defaultMessage: 'Denim'})},
                                {value: 'sapphire', display_name: defineMessage({id: 'admin.customization.defaultTheme.options.sapphire', defaultMessage: 'Sapphire'})},
                                {value: 'quartz', display_name: defineMessage({id: 'admin.customization.defaultTheme.options.quartz', defaultMessage: 'Quartz'})},
                                {value: 'indigo', display_name: defineMessage({id: 'admin.customization.defaultTheme.options.indigo', defaultMessage: 'Indigo'})},
                                {value: 'onyx', display_name: defineMessage({id: 'admin.customization.defaultTheme.options.onyx', defaultMessage: 'Onyx'})},
                            ],
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                        },
                        {
                            type: 'bool',
                            key: 'ThemeSettings.RequireTheme',
                            label: defineMessage({id: 'admin.customization.requireTheme.title', defaultMessage: 'Require Theme:'}),
                            help_text: defineMessage({id: 'admin.customization.requireTheme.desc', defaultMessage: 'When enabled, all users are forced to use the default theme selected above. Users will not be able to change their theme in Display Settings.'}),
                            isDisabled: it.not(it.userHasWritePermissionOnResource(RESOURCE_KEYS.SITE.CUSTOMIZATION)),
                        },
                    ],
                },
    ...
    authentication: {
        ...
        subsections: {
            ...
            oauth2: {
                url: 'authentication/oauth2',
                title: defineMessage({id: 'admin.sidebar.oauth2', defaultMessage: 'OAuth 2.0 (Generic)'}),
                schema: {
                    id: 'OAuth2Settings',
                    name: defineMessage({id: 'admin.authentication.oauth2', defaultMessage: 'OAuth 2.0 (Generic)'}),
                    settings: [
                        {
                            type: 'bool',
                            key: 'OAuth2Settings.Enable',
                            label: defineMessage({id: 'admin.oauth2.enableTitle', defaultMessage: 'Enable OAuth 2.0 Authentication:'}),
                            help_text: defineMessage({id: 'admin.oauth2.enableDescription', defaultMessage: 'When true, Mattermost allows login using a generic OAuth 2.0 provider. Configure the endpoints and credentials below.'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.Id',
                            label: defineMessage({id: 'admin.oauth2.clientIdTitle', defaultMessage: 'Client ID:'}),
                            help_text: defineMessage({id: 'admin.oauth2.clientIdDescription', defaultMessage: 'The Client ID from your OAuth 2.0 provider.'}),
                            placeholder: defineMessage({id: 'admin.oauth2.clientIdExample', defaultMessage: 'E.g.: "your-client-id"'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.Secret',
                            label: defineMessage({id: 'admin.oauth2.clientSecretTitle', defaultMessage: 'Client Secret:'}),
                            help_text: defineMessage({id: 'admin.oauth2.clientSecretDescription', defaultMessage: 'The Client Secret from your OAuth 2.0 provider.'}),
                            placeholder: defineMessage({id: 'admin.oauth2.clientSecretExample', defaultMessage: 'E.g.: "your-client-secret"'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.AuthEndpoint',
                            label: defineMessage({id: 'admin.oauth2.authEndpointTitle', defaultMessage: 'Authorization Endpoint:'}),
                            help_text: defineMessage({id: 'admin.oauth2.authEndpointDescription', defaultMessage: 'The URL to redirect users to for authorization.'}),
                            placeholder: defineMessage({id: 'admin.oauth2.authEndpointExample', defaultMessage: 'E.g.: "https://provider.com/oauth/authorize"'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.TokenEndpoint',
                            label: defineMessage({id: 'admin.oauth2.tokenEndpointTitle', defaultMessage: 'Token Endpoint:'}),
                            help_text: defineMessage({id: 'admin.oauth2.tokenEndpointDescription', defaultMessage: 'The URL to exchange the authorization code for an access token.'}),
                            placeholder: defineMessage({id: 'admin.oauth2.tokenEndpointExample', defaultMessage: 'E.g.: "https://provider.com/oauth/token"'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.UserAPIEndpoint',
                            label: defineMessage({id: 'admin.oauth2.userApiEndpointTitle', defaultMessage: 'User API Endpoint:'}),
                            help_text: defineMessage({id: 'admin.oauth2.userApiEndpointDescription', defaultMessage: 'The URL to fetch user info with the access token. Must return JSON with at least "email" and an identifier field ("id", "sub", or "uid").'}),
                            placeholder: defineMessage({id: 'admin.oauth2.userApiEndpointExample', defaultMessage: 'E.g.: "https://provider.com/api/userinfo"'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.Scope',
                            label: defineMessage({id: 'admin.oauth2.scopeTitle', defaultMessage: 'Scope:'}),
                            help_text: defineMessage({id: 'admin.oauth2.scopeDescription', defaultMessage: 'The OAuth scopes to request. Leave empty if unsure. Do NOT include "openid" unless you actually want OpenID Connect behavior.'}),
                            placeholder: defineMessage({id: 'admin.oauth2.scopeExample', defaultMessage: 'E.g.: "profile email"'}),
                        },
                        {
                            type: 'text',
                            key: 'OAuth2Settings.ButtonText',
                            label: defineMessage({id: 'admin.oauth2.buttonTextTitle', defaultMessage: 'Button Name:'}),
                            help_text: defineMessage({id: 'admin.oauth2.buttonTextDescription', defaultMessage: 'The text displayed on the login button.'}),
                            placeholder: defineMessage({id: 'admin.oauth2.buttonTextExample', defaultMessage: 'E.g.: "Sign In With MyProvider"'}),
                        },
                        {
                            type: 'color',
                            key: 'OAuth2Settings.ButtonColor',
                            label: defineMessage({id: 'admin.oauth2.buttonColorTitle', defaultMessage: 'Button Color:'}),
                            help_text: defineMessage({id: 'admin.oauth2.buttonColorDescription', defaultMessage: 'The hex color of the login button.'}),
                        },
                    ],
                },
            },
